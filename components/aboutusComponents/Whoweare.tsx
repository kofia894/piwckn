  ...
  return (
    <div className="z-10 bg-white mt-10 md:mt-44 lg:mt-72 pb-72 rounded-b-[85px] md:justify-around h-screen w-screen flex flex-col md:flex-row md:content-center items-center justify-center text-white " >
      <div className="z-20 lg:w-[50vw] lg:relative  flex flex-col items-center justify-center absolute content-center space-y-10 ">
        ...
        <p className="italic leading-loose text-lg font-base text-center  text-white lg:text-primary" data-aos="fade-up" data-aos-duration="1000" >A missionary wing of the Church of Pentecost, PIWC-KN is guided by the tenets outlined by the church. The Church of Pentecost deems our tenets or beliefs as one of the most critical aspects of our worship because it forms the basics of the Christian doctrine</p>
      </div>
