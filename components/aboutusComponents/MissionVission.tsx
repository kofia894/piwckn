  ...
  return (
    <div className='lg:section'>
      ...
      <div className="lg:section md:justify-around h-screen w-screen flex flex-col md:flex-row-reverse md:content-center items-center justify-center lg:my-24">
        <div className="lg:max-w-[50vw] lg:relative lg:flex flex-col items-center justify-center absolute grid content-center">
          <h1 className='z-40 mb-4 lg:text-7xl text-5xl  font-Barlow font-extrabold text-center lg:text-primary text-white' data-aos="fade-up" data-aos-duration="1000" > Our Vision</h1>
          <h2 className="z-40 mb-4 lg:text-3xl text-xl font-light text-center text-white lg:text-primary italic px-3 lg:w-[80%]" data-aos="fade-up" data-aos-duration="1000" >"To become a global Pentecostal church that is culturally relevant in vibrant evangelism, church planting and holistic ministry"</h2>
        </div>
